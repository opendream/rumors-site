              ...
              <div className="content">
                <div className="row justify-content-center">
                  <div className="col-12 col-lg-8">
                    ...
                    <p>ดังนั้นภาคประชาสังคมในประเทศไทยเราก็ต้องการสร้างพื้นที่กลางที่เปิดกว้าง ปลอดภัย และสร้างสรรค์ในการที่จะค้นหาความจริงร่วมกัน  ในยุคที่ข้อมูลข่าวสารเต็มไปด้วยความเข้าใจผิด สับสนอลหม่าน  จนบางครั้งยากที่จะเชื่อใครหรืออะไรได้ </p>
                    ...
                    <p>เบื้องต้นเราได้รับการสนับสนุนจากองค์กรที่ให้ความสำคัญกับเรื่องนี้ คือ สำนักงานสนับสนุนการสร้างเสริมสุขภาพ (สสส.) Center for Humanitarian Dialogue (HD) Friedrich Naumann Foundation for Freedom (FNF)  ซึ่งดำเนินการโดยทีม ChangeFusion และ Opendream มีภาคีผู้สนับสนุนเนื้อหาอย่าง  มูลนิธิเพื่อผู้บริโภค กองทุนสื่อเพื่อความยุติธรรมในสังคม รวมทั้งภาคีภาครัฐอย่างสำนักงานกองทุนพัฒนาสื่อปลอดภัยและสร้างสรรค์ หรือพันธมิตรอย่างชัวร์ก่อนแชร์ รวมทั้งภาคีภาคประชาสังคมในท้องถิ่น มหาวิทยาลัย และ องค์กรวิชาชีพสื่อ เป็นต้น     </p>
                    <p>เราเชื่อว่าการแก้ปัญหาข่าวลวงในยุคดิจิทัลคือการทำให้ทุกคนกลายเป็นคนตรวจสอบข่าวหรือ Fact checker และ สร้างพื้นที่ในการแสวงหาข้อเท็จจริงร่วมกัน โดยเปิดเวทีให้มีตลาดทางความคิดเห็นที่หลากหลาย (Marketplace of Ideas) แยกแยะได้ระหว่างข้อเท็จจริง (Facts) และ ความคิดเห็น (Opinion) โดยเชื่อมั่นในวิจารณญาณของสังคม ท้ายที่สุดแล้วถ้าเราไม่สามารถเชื่ออะไรได้เลย ก็ไม่เชื่อไว้ก่อนจนกว่าจะมีการสืบค้นข้อเท็จจริงจนประจักษ์ร่วมกัน ย่อมดีกว่าการเชื่อไปโดยไม่ไตร่ตรอง หรือ เชื่ออย่างมืดบอด ดังคำพูดของคุณออเดรย์ ถัง ที่กล่าวไว้ในเวทีการประชุมที่กรุงเทพว่า <strong>“Blind trust is worse than no trust!”</strong>   การเชื่ออะไรอย่างมืดบอดนั้นน่ากลัวกว่าการที่เราไม่เชื่อไว้ก่อน  </p>
                    <p>ดังนั้นมาร่วมกันค้นหาตรวจสอบความจริงยุคข้อมูลข่าวสารร่วมกับเรากันเถอะ เริ่มต้นจากเรื่องสุขภาพใกล้ตัวก่อน โดยเฉพาะในสถานการณ์โรคระบาดโควิด19 ที่คุกคามพลเมืองทั่วโลก  ไวรัสที่มาพร้อมกับการระบาดของข้อมูลข่าวสาร (Infodemic) เราได้รวบรวมบความไว้จำนวนหนึ่งแล้ว รอทุกท่านมาเป็นชุมชนคนโคแฟคร่วมกัน เพื่อสร้างสุขภาวะร่วมกันของสังคม  </p>
